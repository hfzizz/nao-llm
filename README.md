...
<ul>
  <li><b>FineTune/Script Folder</b> - This folder contains dataset for RAG and scripts for finetuning the Ollama 3.2 model .</li>
  ...
  <li><b>Scraper Folder</b> - This folder contains required scripts to scrape websites.</li>
